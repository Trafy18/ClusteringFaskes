        ...
        <div class="card">
          ...
          <thead>
              ...
              @foreach($users as $data)
                ...
                <td>{{$centro_rs_bersal in[0] = number_format($n_data_rs_bersalin_cc1/$jml_rs_bersalin_c1,2)}}</td>
...
<!-- Centroid Baru -->
        ...
        <div class="row">
            <div style="overflow-x:auto;" >
            <p> <b> Titik Pusat 3 Tiap <i>Cluster</i></b> </p>
            <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr class="text-center">
              <th>Titik Pusat Awal</th>
            ...
            //hasil perhitungan iterasi3
            </table>
            <p> <b>Perhitungan Setiap Data Ke Setiap <i>Cluster</i> Iterasi 3</b> </p>
            <table id="example1" class="table table-bordered table-striped" >
              <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
          ...
          <p> <b>Pengelompokan Data Dari Iterasi 3</b> </p>
          <table id="example1" class="table table-bordered table-striped" >
          <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
        ...
        <div class="row">
            <div style="overflow-x:auto;" >
            <p> <b> Titik Pusat 4 Tiap <i>Cluster</i></b> </p>
            <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr class="text-center">
              <th>Titik Pusat Awal</th>
            ...
            //hasil perhitungan iterasi4
            </table>
            <p> <b>Perhitungan Setiap Data Ke Setiap <i>Cluster</i> Iterasi 4</b> </p>
            <table id="example1" class="table table-bordered table-striped" >
              <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
          ...
          <p> <b>Pengelompokan Data Dari Iterasi 4</b> </p>
          <table id="example1" class="table table-bordered table-striped" >
          <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
        ...
        <div class="row">
            <div style="overflow-x:auto;" >
            <p> <b> Titik Pusat 5 Tiap <i>Cluster</i></b> </p>
            <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr class="text-center">
              <th>Titik Pusat Awal</th>
            ...
            //hasil perhitungan iterasi5
            </table>
            <p> <b>Perhitungan Setiap Data Ke Setiap <i>Cluster</i> Iterasi 5</b> </p>
            <table id="example1" class="table table-bordered table-striped" >
              <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
          ...
          <p> <b>Pengelompokan Data Dari Iterasi 5</b> </p>
          <table id="example1" class="table table-bordered table-striped" >
          <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
        ...
        <div class="row">
            <div style="overflow-x:auto;" >
            <p> <b> Titik Pusat 6 Tiap <i>Cluster</i></b> </p>
            <table id="example1" class="table table-bordered table-striped">
            <thead>
              <tr class="text-center">
              <th>Titik Pusat Awal</th>
            ...
            //hasil perhitungan iterasi6
            </table>
            <p> <b>Perhitungan Setiap Data Ke Setiap <i>Cluster</i> Iterasi 6</b> </p>
            <table id="example1" class="table table-bordered table-striped" >
              <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
          ...
          <p> <b>Pengelompokan Data Dari Iterasi 6</b> </p>
          <table id="example1" class="table table-bordered table-striped" >
          <thead>
                <tr class="text-center">
                  <th style="vertical-align: middle;" rowspan=2>No</th>
