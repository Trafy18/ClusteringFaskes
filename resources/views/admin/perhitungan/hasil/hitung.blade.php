    ...
    <div class="row">
        <div class="col-12"> 
            <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="{{ url('admin/hitung') }}">ITERASI1</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card-body px-2 pt-0 pb-2">
                ...
                <table class="table table-striped table-border align-items-center mb-0" id="example">
                    ...
                    <tr>
                        ...
                        <th class="text-center text-secondary text-s font-weight-bolder opacity-7">JarakC3</th>
