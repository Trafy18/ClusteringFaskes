    ...
    <div class="row">
        <div class="col-12"> 
            <ul class="nav nav-tabs">
                ...
                <li class="nav-item">
                  <a class="nav-link active " href="{{ url('/admin/hitung2') }}">ITERASI2</a>
                </li>
                <li class="nav-item">
...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body px-2 pt-0 pb-2">
                <div class="table-responsive p-4">
                <table class="table display table-striped table-border align-items-center mb-0" id="table2">
                    <thead>
                    <tr>
