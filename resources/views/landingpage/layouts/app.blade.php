...
<head>
    ...
    <link href="landingpage/vendor-lp/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="landingpage/css/landingpage.css" rel="stylesheet">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center header-transparent">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1><a href="{{ url('/') }}">
                        <img src="{{ asset('landingpage/img/logs.jpg') }}" style="height:2.5rem; width:auto;" alt="">
                        <span> K-MEANS</span>
                    </a></h1>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>K-MEANS</span></strong>. All Rights Reserved
            </div>
            <div class="credits">
    ...
    <script src="landingpage/vendor-lp/php-email-form/validate.js"></script>
