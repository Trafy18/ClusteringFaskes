    ...
    <section id="login">
        <div class="form">
            ...
            @csrf
              ...
              <input type="text" name="name" placeholder="nama" class="form-control rounded-top @error('name')is-invalid @enderror" required value="{{ old('name') }}"/>
              <input type="text" name="email" placeholder="email" class="form-control rounded-top @error('email')is-invalid @enderror" required value="{{ old('email') }}"/>
              <input type="text" name="username" placeholder="username" class="form-control rounded-top @error('username')is-invalid @enderror" required value="{{ old('username') }}" />
              <input type="password" name="password" id="password" placeholder="set a password" class="form-control  @error('password')is-invalid @enderror " required/>
              <i class="fas fa-eye" onclick="show()"></i> 
              <br>
              <button type="submit">SIGN UP</button>
            </form>

            <small class="d-block text-center mt-3">sudah mendaftar? <a href="{{ url('/login') }}">login</a></small>
          </div>
        </div>
    </section>
